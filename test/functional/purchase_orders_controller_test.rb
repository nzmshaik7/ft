...
class PurchaseOrdersControllerTest < ActionController::TestCase
  ...
  test "should create purchase_order" do
    assert_difference('PurchaseOrder.count') do
      post :create, purchase_order: { date_time: @purchase_order.date_time, po_number: @purchase_order.po_number, vendor_id: @purchase_order.vendor_id }
    end
  ...
  test "should update purchase_order" do
    put :update, id: @purchase_order, purchase_order: { date_time: @purchase_order.date_time, po_number: @purchase_order.po_number, vendor_id: @purchase_order.vendor_id }
    assert_redirected_to purchase_order_path(assigns(:purchase_order))
  end
