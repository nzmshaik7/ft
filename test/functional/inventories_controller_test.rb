...
class InventoriesControllerTest < ActionController::TestCase
  ...
  test "should create inventory" do
    assert_difference('Inventory.count') do
      post :create, inventory: { count: @inventory.count, part_id: @inventory.part_id, store_id: @inventory.store_id }
    end
  ...
  test "should update inventory" do
    put :update, id: @inventory, inventory: { count: @inventory.count, part_id: @inventory.part_id, store_id: @inventory.store_id }
    assert_redirected_to inventory_path(assigns(:inventory))
  end
